...
def code(X):
    ...
    # keyword_tweets= tw.Cursor(api.search, q=keyword, lang='en', tweet_mode= 'extended', since=(datetime.timedelta(days=7) - datetime.timedelta(days=14))).items(100)
    ...
    # return temp, Tweets_list, Cleaned_Tweets, PT_df, NT_df, Neut_df, PT_values, NT_values, Pos_tokens, Neg_tokens, Pnoun_list, Pverb_list, Padj_list, Nnoun_list, Nverb_list, Nadj_list


code("Air Canada stocks")
end = (start - time.time())
